...
#
#
# Map artists with usable coordinates on a world map and color by hotness
...
ggplot() +
  ...
  coord_quickmap() +
  labs(
    title = "Artist Locations with Hotness Scores",
    subtitle = "Only artists with usable coordinates and hotness > 0 are shown; color reflects artist hotness",
    x = "Longitude",
    y = "Latitude"
  ) +
  theme_minimal()
