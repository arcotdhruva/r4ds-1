...
#
#
# Map artists with usable coordinates on a world map and color by genre
...
ggplot() +
  ...
  labs(
    ...
    subtitle = "Artists are colored by the first matching genre in rock, pop, blues, jazz, metal; only artists with usable coordinates and a matched genre are shown",
    x = "Longitude",
    y = "Latitude"
  ) +
  theme_minimal()
